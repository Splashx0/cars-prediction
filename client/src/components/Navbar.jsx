...
function Navbar() {
    ...
    return (
        <div className='  text-[#2E2E2E] flex justify-between items-center h-24 max-w-[1280px] m-auto px-4 my-4'>
            ...
            <img className=' hidden md:flex cursor-pointer my-auto bg-[#F5F5F5]' src={logo} alt="Logo" style={{ height: '110px', width: '120px' }} />
            <img className='flex md:hidden cursor-pointer my-auto bg-[#F5F5F5] hover:rotate-12  duration-300' src={logo1} alt="Logo" style={{ height: '80px', width: '90px' }} />
            ...
            <div className={nav ? ' fixed left-0 top-0 w-[60%] border-r h-full bg-white ease-in-out duration-500' : '  ease-in-out duration-500 fixed left-[-100%]'} style={{ zIndex: '2' }}>
                ...
                <img className='flex mx-auto  my-4 cursor-pointer  bg-[white] hover:rotate-12  duration-300' src={logo1} alt="Logo" style={{ height: '80px', width: '90px' }} />
