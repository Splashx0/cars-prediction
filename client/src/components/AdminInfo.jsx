                ...
                <div className='grid md:grid-cols-2  md:gap-20 w-[80%]  ml-[40px] mt-6'>
                    <div>
                        <div className=' flex flex-col '>
                            ...
                            <input className=' mt-3 mb-3 w-[100%] h-[52px] border-[1px] rounded-[16px] border-[#2E2E2E] font-Nunito p-2 bg-[#f3f3f3]' type="text" placeholder='Entrer votre numéro de téléphone' name='numero' value={"123456"} />
                        </div>
                    </div >
                    <div className=' flex flex-col'>
